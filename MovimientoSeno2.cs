...
/*
 Este script sirve para dotar de un patrón de movimiento sencillo (VERTICAL), de un lado a otro, a los objetos enemigos que lo tengan. Este es para otro patrón diferente
 al script MovmientoSeno que está en algunos enemigos.
*/
...
public class MovimientoSeno2 : MonoBehaviour
{
